 ...
 */
 public abstract class GianHang { // tạo một abstract class tên GianHang
    ...
    private String maGianHang;  // Attribute tên là maGianHang kiểu dữ liệu String phạm vi truy cập private
    private double dienTich;    // Attribute tên là dienTich  kiểu dữ liệu double phạm vi truy cập private
    private String viTri;       // Attribute tên là vitri kiểu dữ kiệu String phạm vi truy cập private
/*
    bình thường viết là 
     public GianHang() {
        maGianHang = null;
    ...
    */
    ...
    public void setViTri(String viTri) {  /* hàm chỉnh sửa thuộc tính viTri có tên setViTri 
